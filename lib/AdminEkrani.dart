...
import 'package:yazlab2dnm/DrawerAdmin.dart';
...
Future <void> konumaGit() async{
  ...
  var gidilenKonum = CameraPosition(target: LatLng(41.00296,28.45174),zoom: 8,);

  controller.animateCamera(CameraUpdate.newCameraPosition(gidilenKonum));
...
class AdminHarita extends StatefulWidget {
  const AdminHarita({Key? key}) : super(key: key);

  @override
  _AdminHaritaState createState() => _AdminHaritaState();
}

double ekranyukseklik = 0.0;
double ekrangenislik = 0.0;

class _AdminHaritaState extends State<AdminHarita> {
  @override
  Widget build(BuildContext context) {
